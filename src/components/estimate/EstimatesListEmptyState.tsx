...
export default function EstimatesListEmptyState({
  ...
  return (
    <div className="px-margin-mobile mx-auto flex min-h-[60vh] w-full max-w-[var(--container-desktop)] flex-col items-center justify-start py-38 min-[744px]:px-72 md:min-h-[70vh] md:py-32 lg:px-0 lg:py-64">
      <EmptyState
        size="sm"
