  ...
  return (
    ...
    <div className="relative h-160 w-full shrink-0 md:h-200 lg:h-64.75">
      <div className="bg-background-brand absolute top-0 left-1/2 h-30.5 w-full max-w-480 -translate-x-1/2 overflow-hidden md:h-42.5 lg:h-56.25">
        ...
        <HeroDecorationRightIcon className="text-icon-brand-tertiary pointer-events-none absolute bottom-0 left-[calc(50%+152px)] hidden h-37 w-81.25 lg:block" />
        <HeroDecorationLeftIcon className="text-icon-brand-tertiary pointer-events-none absolute top-[79.39px] left-[calc(50%-750px)] hidden h-28.75 w-42.5 lg:block" />
      </div>
