...
export default function DetailHeroBanner({
  ...
  return (
    ...
    <div className="relative h-160 w-full shrink-0 md:h-200 xl:h-64.75">
      <div className="bg-background-brand absolute top-0 left-1/2 h-30.5 w-full max-w-480 -translate-x-1/2 overflow-hidden md:h-42.5 xl:h-56.25">
