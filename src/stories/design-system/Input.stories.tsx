...
한 줄의 값을 입력받는 공통 필드입니다. \`sm\`은 모바일 기본 규격, \`md\`는 태블릿 이상에서 사용합니다. \`error\` prop을 통해 사용자에게 에러 메시지를 알립니다.
  ...
  argTypes: {
    ...
    leftSlot: { control: false, description: "입력 영역 왼쪽에 배치할 콘텐츠" },
    rightSlot: { control: false, description: "입력 영역 오른쪽에 배치할 콘텐츠" },
    numericOnly: {
      control: "boolean",
    ...
    disabled: { control: "boolean", description: "입력 필드 비활성화 여부" },
...
export const Playground: Story = {
  parameters: { docs: { source: { code: INPUT_SOURCE, language: "tsx" } } },
...
export const NumericOnly: Story = {
  args: { numericOnly: true, inputMode: "numeric", placeholder: "숫자만 입력" },
  parameters: {
    docs: {
      description: { story: "금액처럼 숫자만 허용해야 하는 입력에 사용합니다." },
      source: { code: NUMERIC_SOURCE, language: "tsx" },
    },
  },
  render: (args) => <ControlledInput {...args} />,
};
