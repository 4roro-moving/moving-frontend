...
/** 기사 프로필 등록/수정 메시지 */
export const MOVER_PROFILE_CREATE_ERROR_MESSAGE = "프로필 저장에 실패했습니다.";

export const MOVER_PROFILE_EDIT_SUCCESS_MESSAGE = "프로필이 수정되었습니다.";

export const MOVER_PROFILE_EDIT_ERROR_MESSAGE = "프로필 수정에 실패했습니다.";
